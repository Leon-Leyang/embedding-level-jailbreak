...
python train.py \
    ...
    --config sampling --pretrained_model_path ${model} \
    --output_path ./trained_prompts_pca \
    --estimation_path ./estimations_pca
#"""
...
python generate.py \
    ...
    --output_path ./outputs_pca \
    --soft_prompt_path ./trained_prompts_pca

python evaluate.py \
    --config sampling --use_harmless --use_testset \
    --model_names ${model_name}_with_soft_${system_prompt_type}_${prompt_length} \
    --generation_output_path ./outputs_pca \
    --output_path ./eval_results_pca
#"""
